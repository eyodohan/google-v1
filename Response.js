export default {
  ...
  searchInformation: {
    ...
    totalResults: '1910000000',
    formattedTotalResults: '1,910,000,000',
  },
  items: [
    {
        ...
        metatags: [
          {
            ...
            last_mod: 'Sat, 07 May 2022 21:47:00 GMT',
            'dc.creator': 'HELLO!',
    ...
    },
    {
      ...
      htmlSnippet:
        '&quot;<b>Hello</b>&quot; is a song recorded by English singer-songwriter Adele, released on 23 October 2015 by XL Recordings as the lead single from her third studio album,&nbsp;...',
    ...
    {
      kind: 'customsearch#result',
      title: 'Hello Group Inc. - Investors - Investor Home',
      htmlTitle: '<b>Hello</b> Group Inc. - Investors - Investor Home',
      link: 'https://ir.hellogroup.com/',
      displayLink: 'ir.hellogroup.com',
      snippet:
        'Momo is a fun and simple way to discover, meet and make friends with people nearby.',
      htmlSnippet:
        'Momo is a fun and simple way to discover, meet and make friends with people nearby.',
      cacheId: 'm4VBj_LjvMwJ',
      formattedUrl: 'https://ir.hellogroup.com/',
      htmlFormattedUrl: 'https://ir.<b>hello</b>group.com/',
      pagemap: {
        metatags: [
          {
            'og:type': 'website',
            'og:site_name': 'Hello Group Inc.',
            handheldfriendly: 'true',
            viewport: 'width=device-width, initial-scale=1.0',
            'og:title': 'Investor Home | Hello Group Inc.',
            mobileoptimized: 'width',
            'og:url': 'https://ir.hellogroup.com/investor-overview',
            'og:description':
